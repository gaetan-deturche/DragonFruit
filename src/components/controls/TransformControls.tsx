...
interface TransformControlsProps {
  ...
  /** Compute + apply an optimized build orientation (minimizes supports). */
  onAutoOrient?: () => void;
            ...
            <div className="pt-1.5 space-y-2">
                ...
                {onAutoOrient ? (
                  <button
                    ...
                    disabled={!modelBBox}
                    title="Rotate the model to an orientation that minimizes supports"
                    className="ui-button w-full !h-8 px-1.5 text-[10px] sm:text-[11px] font-semibold disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center gap-1"
                    style={{
                      borderColor: 'color-mix(in srgb, var(--accent), white 10%)',
